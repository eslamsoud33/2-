...
export const FormatQuestionText: React.FC<FormatQuestionTextProps> = ({ text, concept }) => {
  ...
  return (
    <React.Fragment>
      {starterSpan}
      <HighlightText text={remainingText} concept={concept} />
    </React.Fragment>
  );
};
